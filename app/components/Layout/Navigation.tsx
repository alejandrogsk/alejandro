  ...
  return (
    <header className='absolute top-[30px] left-0 right-0 z-10'>
        ...
        mx-[1rem] sm:mx-[2rem] md:mx-[3.12rem] lg:mx-[6.25rem] xl:mx-[7rem] big:mx-[9rem] bigXl:mx-auto'>
            ...
            className="flex justify-center uppercase block bg-black hover:bg-white text-white hover:text-black text-xs md:text-sm w-[150px] md:w-[170px] py-2 md:py-3 rounded-full shadow-lg	">Contact Me Now</a>
        </nav>
    </header>
  )
}
